...
public class GradStudent implements Student {
		...
		String name;
		int sem=0;
		double stud[][] =new double [4][3];
		double sem_sum[]= new double [4];
		double sem_avg[] = new double [4];
		double tot_avg=0;
		double tot_sum=0;
		

		public GradStudent(String string) {
		...
		public void showStudentInfo() {
			System.out.println("=========================================================");
			System.out.println("대학원 "+sem+"학기 "+name); //학생의 소속과 학기, 이름 출력
		...
		public void addSemester(int i, double[] s) {
			...
			sem_avg[i]= sem_sum[i]/s.length; //학기 성적평균 계산
